...
from utilities import polynomial_fitting as polyfit
...
times = np.linspace(start = 0, stop = len(coincidenze_OFF)-1, num= len(coincidenze_OFF), endpoint=True, retstep=False, dtype=None)
...
if verbose:
    plotting(x = times_cutted, y = differences_cutted, name = 'differences_cutted', x_axis= 'times', y_axis= 'coincidences', marker= 'none')
